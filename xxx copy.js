    ...
    for (var i = 0; i < selectors.length; i++) {
      (function (callback, req, res) {
        ...
        var callbackInvoker  = function(element) {
          ...
          // Generate auto-incremented ID and add it to the selected element
          console.log('element', element);
          if (element && element.getAttribute) {
            var idPrefix = (selectors[i] && selectors[i].idPrefix !== undefined )? selectors[i].idPrefix : 'prefix-'; // Default prefix 'NNN' if not provided
